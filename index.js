...
function clickRight() {
  switch(newValue){
    case -270:
      ...
      document.querySelector('.project4-container').setAttribute("aria-hidden");
    case -540:
      ...
      document.querySelector('.project5-container').setAttribute("aria-hidden");
      break;
      default:
        break;
  }
...
function clickLeft() {
  switch(newValue){
    case -270:
      ...
      document.querySelector('.project2-container').setAttribute("aria-hidden");
    case 0:
      document.querySelector('.project4').setAttribute("tabindex", "-1");
      document.querySelector('.project4-container').setAttribute("aria-hidden","true");
      document.querySelector('.project1').removeAttribute("tabindex");
      document.querySelector('.project1-container').setAttribute("aria-hidden");
      break;
      default:
        break;
  }
